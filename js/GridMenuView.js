...
import GridMenuGroupView from './GridMenuGroupView';
class GridMenuView extends MenuView {
  className() {
  ...
  addChildren() {
    ...
    models.forEach((model) => {
      ...
      const ChildView =
        model.get('_type') === 'menu' && model.get('_gridMenu') && model.get('_gridMenu')._renderAsGroup ? GridMenuGroupView : GridMenuItemView;
